...
class GRUBaselineNet(nn.Module):
    """Small GRU encoder plus linear classifier baseline."""
    ...
    def forward(self, x, mask):
        """Return the final valid hidden state and its classification logits."""
        out, _ = self.gru(x)
...
def main():
    """Train the baseline and report aggregate performance on the holdout split."""
    seed_everything(42)
